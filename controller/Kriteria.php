...
function Add($table, $data)
{
    ...
    $tempatguru = htmlspecialchars($data["nm_kriteria"]);
    $bobot = htmlspecialchars($data["bobot"]);
    $status = htmlspecialchars($data["status"]);
    $query = "INSERT INTO $table VALUES (null, '$kode', '$tempatguru','$bobot','$status')";
...
function Edit($table, $data)
{
    ...
    $bobot = htmlspecialchars($data["bobot"]);
    $status = htmlspecialchars($data["status"]);
    $query = "UPDATE $table SET kode_kriteria = '$kode', nm_kriteria = '$tempatguru', bobot = '$bobot', status = '$status' WHERE id_kriteria = $idkriteria";
