...
?>
<link rel="stylesheet" href="../asset/css/addbobot.css">
                ...
                <div class="column">
                    <div class="card">
                        <div class="card-header">
                            <p class="card-header-title">Pemberian Nilai Kinerja Guru</p>
                            ...
                            <form action="" method="post">
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <div class="select">
                                            <select name="id_guru">
                                                <option selected disabled>Pilih Data Alternatif</option>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="Masukkan Nilai" name="nilai">
                                    </div>
                                </div>
                                <div class="buttons">
